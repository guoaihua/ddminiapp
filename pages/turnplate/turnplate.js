...
Page({
  ...
  data: {
    ...
    anima_scale: "",
    turnaudio:
      "https://zm-1253465948.cos.ap-nanjing.myqcloud.com/static/dd/turn.mp3",
  },
  ...
  confirm() {
    ...
    const self = this;
    wx.request({
      url: `https://ziming.online/ddphoto/checkMsg?message=${JSON.stringify(
        temp
      )}`,
      method: "GET",
      success(result) {
